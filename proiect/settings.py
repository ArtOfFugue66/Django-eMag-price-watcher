...
SECRET_KEY = 'django-insecure-a#s3d1uyv=114c4@cycr(-!k%-27*)bakbmwn2rh&_t1!oc$_@'
...
# Page to be redirected to after a successful login
LOGIN_REDIRECT_URL = 'watchlist/'
# Page to be redirected to after a successful logout
LOGOUT_REDIRECT_URL = '/'
